...
public class UpdateMIF_2 : AppPageModel
{
    ...
    public UpdateMIF_2(IDb db, IExcelFileReader excelFileReader, IAddJournalRecord addJournalRecord,
            ...
            try
            {
                if (readModel.FormFile.Length > 0)
                {
                    ...
                    for (var i = 0; i <= data.Rows.Count; i++)
                    {
                        ...
                        var records = _db.Query<JournalRecord>().FilterByCategory(categoryName)
