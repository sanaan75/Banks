...
JustGage = function (config) {
    ...
    obj.config = {
        ...
        // color of gauge title
        titleFontFamily: kvLookup('titleFontFamily', config, dataset, "inherit"),
        ...
        // color of label showing current value
        valueFontFamily: kvLookup('valueFontFamily', config, dataset, "inherit"),
        ...
        titleMinFontSize: kvLookup('titleMinFontSize', config, dataset, 13),

        // labelMinFontSize
        // absolute minimum font size for the label
        labelMinFontSize: kvLookup('labelMinFontSize', config, dataset, 13),

        // minLabelMinFontSize
        // absolute minimum font size for the minimum label
        minLabelMinFontSize: kvLookup('minLabelMinFontSize', config, dataset, 13),

        // maxLabelMinFontSize
        // absolute minimum font size for the maximum label
        maxLabelMinFontSize: kvLookup('maxLabelMinFontSize', config, dataset, 13),
    ...
    if (obj.config.donut === true) {
        ...
        // title
        titleFontSize = ((widgetH / 8) > 10) ? (widgetH / 10) : 13;
        titleX = dx + widgetW / 2;
        ...
        // label
        labelFontSize = ((widgetH / 16) > 10) ? (widgetH / 16) : 13;
        labelX = dx + widgetW / 2;
        labelY = valueY + labelFontSize + 5;

        // min
        minFontSize = ((widgetH / 16) > 10) ? (widgetH / 16) : 13;
        minX = dx + (widgetW / 10) + (widgetW / 6.666666666666667 * obj.config.gaugeWidthScale) / 2;
        minY = labelY;

        // max
        maxFontSize = ((widgetH / 16) > 10) ? (widgetH / 16) : 13;
